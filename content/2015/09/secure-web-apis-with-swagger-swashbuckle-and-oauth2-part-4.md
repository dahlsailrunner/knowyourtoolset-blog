...
summary: "Writing an ASP.NET Framework Web API that uses Swashbuckle for a Swagger UI and OAuth2 for security - restricting access to the Swagger UI" # Description used for search engine.
