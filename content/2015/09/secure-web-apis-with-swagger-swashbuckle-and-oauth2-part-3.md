...
summary: "Writing an ASP.NET Framework Web API that uses Swashbuckle for a Swagger UI and OAuth2 for security - customizing the user interface." # Description used for search engine.
