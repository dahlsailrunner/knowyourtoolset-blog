...
summary: "Preventing the inclusion of a scroll bar in a ReadTheDocs table - all of the content will show on the page and in the table - just taller." # Description used for search engine.
